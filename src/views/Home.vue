		...
		>
			<Container>
				<div class="w-full max-w-2xl space-y-4 mx-auto text-center">
					...
					<h2 class="text-base lg:text-xl font-display tracking-tight text-center">{{ content.services.subtitle }}</h2>
				</div>
			</Container>
		...
		<Section id="contact" class="bg-gradient-to-br from-primary-600 to-primary-800">
			<Container class="text-center text-white">
				...
				<div class="w-full max-w-2xl space-y-4 mx-auto text-center text-base">
					...
					<p class="pt-8">
						<a href="/privacy-policy" class="inline-flex rounded-lg border border-white/30 px-4 py-2 text-base font-medium text-white transition-colors hover:bg-white hover:text-primary-700">Your Privacy Choices</a>
					</p>
				</div>
			</Container>
		</Section>
